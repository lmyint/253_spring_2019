...
$$RSS = \sum_{i=1}^n (y_i - \hat{y_i})^2 = (y_1 - \hat{y_1})^2 + (y_2 - \hat{y_2})^2 + \cdots + (y_n - \hat{y_n})^2$$
...
$$MSE = \frac{RSS}{n} = \sum_{i=1}^n (y_i - \hat{y_i})^2$$
...
- Most interpretable: the proportion of variation in the response that is explained by the model
