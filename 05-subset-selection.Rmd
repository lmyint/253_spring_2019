...
`r NextQ()`. **Backward stepwise selection in `caret`**    
    We can use the `caret` package to perform backward stepwise selection with cross validation as shown below. Just focus on the structure of the code and how different parts of the output are used.    
