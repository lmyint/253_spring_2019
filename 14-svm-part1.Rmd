...
`r NextQ()`. **Maximal margin hyperplane** (related to Exercise 3 in Section 9.7 of ISLR)
    ...
    e. Would moving case 7 a tiny bit move the hyperplane? Why or why not?
    f. Would moving case 5 a tiny bit move the hyperplane? Why or why not?
