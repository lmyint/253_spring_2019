...
Each group will schedule a time to meet with me to present (informally) the following items involved in starting up the project. A Google Doc will be linked here where your group can sign up for a time slot to do this initial check-in with me.
...
DUE: Friday, May 3 and Monday, May 6

The last 2 days of class will be reserved for project presentations. I have not decided yet whether the presentations will be a poster or slides, but you will be presenting to other students. The points you should emphasize for the presentation are the same 4 points that you should emphasize for the final report (detailed above).
